                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        if (isset($_GET["UpdateAnnouncement"])) {
                            $query = "SELECT * FROM announcements WHERE id=" . $_GET["UpdateAnnouncement"];
                            $result = $conn->query($query);
                            $user = $result->fetch_object();
                            ?>
                            <div class="collapse mb-3 show" id="collapseEditAnnouncement">
                                <div class="card card-body">
                                    <h5 class="card-title"></h5>
                                    <form class="user" action="../includes/process.php" method="POST">
                                        <div class="mb-3 row">
                                        ...
                                        <div class="text-end mt-5 pt-5">
                                            <input type="hidden" name="UpdateAnnouncement" />
                                            <input type="hidden" name="Author"
                                                value="<?= $acc->FirstName ?> <?= $acc->LastName ?>" />
                                            <button type="button" class="btn btn-secondary" data-bs-toggle="collapse"
                                                data-bs-target="#collapseEditAnnouncement">Cancel</button>
